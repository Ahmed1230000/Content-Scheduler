...
<div class="max-w-3xl mx-auto bg-white p-8 rounded shadow">
    ...
    <form method="POST" action="{{ route('posts.update', $post->id) }}" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="url" name="image_url" id="image_url" value="{{ old('image_url', $post->image_url) }}"
        ...
        <div class="mb-4">
            ...
            <input type="datetime-local" name="scheduled_time" id="scheduled_time"
                value="{{ old('scheduled_time', $post->scheduled_time ? $post->scheduled_time : '') }}"
        ...
        <div class="mb-4">
            ...
            $selectedPlatforms = old('platforms', $post->platforms->pluck('id')->toArray());
            @endphp
